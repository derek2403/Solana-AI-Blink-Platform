...
export default function handler(req, res) {
  ...
  "label": "Pet Safety Awareness",
  "title": "Prevent Animal Cruelty: Stop Dog Killing",
  "description": "Join the movement to protect our furry friends. Support our cause to end the violence against dogs and promote animal cruelty awareness.",
  "links": {
    "actions": [
      {
